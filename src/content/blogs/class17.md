...
Quantum cryptography (better called "quantum key distribution") is often described as the "future of secure communication", but in reality it is a brilliant idea that does not solve any real problem.

At its core are strange properties of quantum physics: light behaves as both a wave and a particle, and exists in multiple states at once (superposition) until observed. When measured, it randomly collapses into a single state based on a probability distribution. This unpredictability is reinforced by the quantum uncertainty principle, which states that the more precisely you know one property of a particle (like position), the less you can know about another (like momentum). 

As a result, quantum information cannot be perfectly copied (known as the “no-cloning” principle) unlike classical bits, which can be duplicated exactly. 

Photons also have polarization (often described as “spin”), and by passing them through vertical, horizontal, or angled filters, we can encode information. 
...
A vertically polarized photon will always pass through a vertical filter but never through a horizontal one, while a 45° filter only lets it pass with 50% probability. If you send a stream of photons, about half will pass through half-mismatched filters. After passing through a filter, the photon adopts the filter’s polarization. This ability to control and test photon polarization is what makes quantum encoding possible.
...
The key property is that you cannot measure the sequence without disturbing it, any attempt to copy or learn it destroys the information. Even if a photon passes through a filter, you cannot tell whether it was correctly aligned or just passed by chance. TThe bank, that knows the correct polarization of the photons on the note can authenticate the note by aligning the filters appropriately. Note that 
authentication destroys the note.  This makes quantum money theoretically unforgeable! It is, however, completely impractical, since it is difficult to maintain photons in their state.

A similar idea results in Quantum Key Distribution (QKD), where two parties share a secret sequence of polarization filters to securely communicate. Any eavesdropping introduces detectable errors because measurement alters the photons. Still, QKD requires expensive, specialized infrastructure, is sensitive to noise and distance, and doesn't solve any problem that isn't well solved by asymmetric cryptography. As a result, despite heavy investment, quantum cryptography is appealing in theory but of limited value in practice (although there have been companies selling it and much investment by governments who have excessive distrust of aysmmetric cryptography on it).

---

## Lead Team Presentation: AI, Automation, and Universal Basic Income 

**Presented by Group 7**: [Slides](https://docs.google.com/presentation/d/1IHQ2mNCiK1Zhkc0y5FjKCvQ_xsgEhsYlxHavihtIvzU/edit?slide=id.p#slide=id.p)
...
An argument in support that was discussed is that it could fundamentally improve how people live and make decisions. Chris Hughes notes, 
>“The further you get from subsistence, the easier it is to ask fundamental questions like: what do I want, and how do I get it?” 

When people are not constantly worried about survival, they gain the freedom to pursue education, care for family, start businesses, or explore meaningful work beyond just earning money. Contrary to common fears, real-world UBI pilot programs show that people do not waste unconditional cash; instead, they tend to invest in their futures, support their families, and make more stable long-term plans. This challenges the traditional assumption that guaranteed income reduces motivation. 
...
Rodríguez, M. (2023). Universal Basic Income: Is It Already Here?. <br>
...
The team then summarized some real‑world UBI pilot programs:
...
LessWrong Community. (n.d.). What You Really Mean When You Claim to Support UBI for Job Loss.
